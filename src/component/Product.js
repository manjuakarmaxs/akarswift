    ...
    <div class="accordion" id="productAccordion">
        ...
        <h2 className="accordion-header" id="headingOne" >
            ...
            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#productAccordion">
                <div class="accordion-body">
                    <div class="card mb-3">
                        <div class="card-header"><strong>Fresh Produce, Grains, and Spices</strong></div>
                        <div class="card-body">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#productAccordion">
                <div class="accordion-body">
                    <div class="card mb-3">
                        <div class="card-header"><strong>Machinery, Tools, and Raw Materials</strong></div>
                        <div class="card-body">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#productAccordion">
                <div class="accordion-body">
                    <div class="card mb-3">
                        <div class="card-header"><strong>Electronics, Apparel, and Home Goods</strong></div>
                        <div class="card-body">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#productAccordion">
                <div class="accordion-body">
                    <div class="card mb-3">
                        <div class="card-header"><strong>High-Quality Medicines and Healthcare Products</strong></div>
                        <div class="card-body">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#productAccordion">
                <div class="accordion-body">
                    <div class="card mb-3">
                        <div class="card-header"><strong>Vehicles and Automotive Parts</strong></div>
                        <div class="card-body">
        ...
        <div class="accordion-item">
            ...
            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#productAccordion">
                <div class="accordion-body">
                    <div class="card mb-3">
                        <div class="card-header"><strong>Eco-friendly Synthetic Paper</strong></div>
                        <div class="card-body">
