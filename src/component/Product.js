      ...
      <div className="container my-5">
        ...
        <div className="accordion" id="productAccordion">
            ...
            <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#productAccordion">
              <div className="accordion-body">
                <div className="card mb-3">
                  <div className="card-header"><strong><h4>Fresh Produce, Grains, and Spices</h4></strong></div>
          ...
          <div className="accordion-item" data-aos="fade-up" data-aos-delay="100">
            ...
            <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#productAccordion">
              <div className="accordion-body">
                <div className="card mb-3">
                  <div className="card-header"><strong><h4>Machinery, Tools, and Raw Materials</h4></strong></div>
                  <div className="card-body">
          ...
          <div className="accordion-item" data-aos="fade-up" data-aos-delay="200">
            ...
            <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#productAccordion">
              <div className="accordion-body">
                <div className="card mb-3">
                  <div className="card-header"><strong><h4>Electronics, Apparel, and Home Goods</h4></strong></div>
                  <div className="card-body">
          ...
          <div className="accordion-item" data-aos="fade-up" data-aos-delay="300">
            ...
            <div id="collapseFour" className="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#productAccordion">
              <div className="accordion-body">
                <div className="card mb-3">
                  <div className="card-header"><strong><h4>High-Quality Medicines and Healthcare Products</h4></strong></div>
                  <div className="card-body">
          ...
          <div className="accordion-item" data-aos="fade-up" data-aos-delay="400">
            ...
            <div id="collapseFive" className="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#productAccordion">
              <div className="accordion-body">
                <div className="card mb-3">
                  <div className="card-header"><strong><h4>Vehicles and Automotive Parts</h4></strong></div>
                  <div className="card-body">
          ...
          <div className="accordion-item" data-aos="fade-up" data-aos-delay="500">
            ...
            <div id="collapseSix" className="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#productAccordion">
              <div className="accordion-body">
                <div className="card mb-3">
                  <div className="card-header"><strong><h4>Eco-friendly Synthetic Paper</h4></strong></div>
                  <div className="card-body">
